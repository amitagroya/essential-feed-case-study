...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversNonItemOn200HTTPResponseWithEmptyJSONList() {
        let (sut, client) = makeSUT()
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item2 = makeItem(id: UUID(), description: "a description", location: "a loaction", imageURL: URL(string: "https://another-url.com")!)
    ...
    func test_load_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
        let url = URL(string: "https://anyGivenURL.com")!
